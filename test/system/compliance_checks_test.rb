...
class ComplianceChecksTest < ApplicationSystemTestCase
  setup do
    @compliance_check = compliance_checks(:one)
  end

  test "visiting the index" do
    visit compliance_checks_url
  ...
  test "should create compliance check" do
    ...
    fill_in "Entity", with: @compliance_check.entity_id
    fill_in "Explanation", with: @compliance_check.explanation
    fill_in "Owner", with: @compliance_check.owner_id
    fill_in "Owner type", with: @compliance_check.owner_type
    fill_in "Parent", with: @compliance_check.parent_id
    fill_in "Parent type", with: @compliance_check.parent_type
    fill_in "Status", with: @compliance_check.status
  ...
  test "should update Compliance check" do
    visit compliance_check_url(@compliance_check)
