...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { count: @reminder.count, entity_id: @reminder.entity_id, owner_id: @reminder.owner_id, owner_type: @reminder.owner_type, sent: @reminder.sent, unit: @reminder.unit } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { count: @reminder.count, entity_id: @reminder.entity_id, owner_id: @reminder.owner_id, owner_type: @reminder.owner_type, sent: @reminder.sent, unit: @reminder.unit } }
