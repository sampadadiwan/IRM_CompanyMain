...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference("Fee.count") do
      post fees_url, params: { fee: { advisor_name: @fee.advisor_name, amount: @fee.amount, amount_label: @fee.amount_label, entity_id: @fee.entity_id, owner_id: @fee.owner_id } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { advisor_name: @fee.advisor_name, amount: @fee.amount, amount_label: @fee.amount_label, entity_id: @fee.entity_id, owner_id: @fee.owner_id } }
