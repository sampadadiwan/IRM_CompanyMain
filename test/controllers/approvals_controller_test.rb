...
class ApprovalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create approval" do
    assert_difference("Approval.count") do
      post approvals_url, params: { approval: { agreements_reference: @approval.agreements_reference, approved_count: @approval.approved_count, entity_id: @approval.entity_id, rejected_count: @approval.rejected_count, title: @approval.title } }
    end
  ...
  test "should update approval" do
    patch approval_url(@approval), params: { approval: { agreements_reference: @approval.agreements_reference, approved_count: @approval.approved_count, entity_id: @approval.entity_id, rejected_count: @approval.rejected_count, title: @approval.title } }
