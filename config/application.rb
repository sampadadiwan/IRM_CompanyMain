...
module InvestorRelationshipManagement
  class Application < Rails::Application
    ...
    core_view_paths = %w[access_rights documents entities folders notes permissions reminders tasks users investors investor_accesses valuations form_types form_custom_fields approvals payments nudges import_uploads misc investor_kycs fees]
