...
module CapHive
  class Application < Rails::Application
    ...
    misc_view_paths = %w[approvals form_types form_custom_fields payments investor_notices import_uploads esigns kanbans key_biz_metrics grid_view_preferences events]
