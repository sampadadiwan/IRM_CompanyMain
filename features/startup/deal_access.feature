...
Scenario Outline: Access Deal as Investor with access
  ...
  Examples:
  	...
  	|false  	  |entity_type=Startup  |name=Series A;amount_cents=100 | access_type=Deal;access_to_investor_id=3          | approved=1 |
    |false  	  |entity_type=Startup  |name=Series B;amount_cents=120 | access_type=Deal;access_to_category=Lead Investor | approved=1 |
    ...
    |false      |entity_type=Startup  |name=Series B;amount_cents=120 | access_type=Deal;access_to_category=Co-Investor   | approved=1 |
	  |false      |entity_type=Startup  |name=Series A;amount_cents=100 | access_type=Deal;access_to_investor_id=3          | approved=0 |
