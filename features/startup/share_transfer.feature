...
Scenario Outline: Share Transfer betw Investors
  ...
  Given there is another user "first_name=Investor1" for another entity "name=From;entity_type=Investor"
  ...
  Given there is another user "first_name=Investor2" for another entity "name=To;entity_type=Investor"
