...
Scenario Outline: Share Transfer betw Investors
  ...
  Given there is another user "first_name=Investor1" for another entity "name=From;entity_type=Investor;pan=1234567"
  And another entity is an investor "category=Lead Investor;pan=1234567" in entity
  And given there is a investment "<investment>" for the entity 
  Given there is another user "first_name=Investor2" for another entity "name=To;entity_type=Investor;pan=7654321"
  And another entity is an investor "category=Co Investor;pan=7654321" in entity
  ...
  Examples:
  	...
  	|  	      |entity_type=Company  |quantity=100;investment_instrument=Equity      | 10        |
    |  	      |entity_type=Company  |quantity=120;investment_instrument=Preferred   | 20        |    
...
Scenario Outline: Share Conversion rom Pref to Equity
  ...
  Examples:
  	...
  	|entity_type=Company  |quantity=100;investment_instrument=Preferred                       | 10        |
    |entity_type=Company  |quantity=120;investment_instrument=Preferred;preferred_conversion=2| 20        |    
...
Scenario Outline: Share Transfer from Holding to Investors
  ...
  Examples:
  	...
  	|  	      |entity_type=Company  |orig_grant_quantity=100;investment_instrument=Equity      | 10        |
    |  	      |entity_type=Company  |orig_grant_quantity=120;investment_instrument=Preferred   | 20        |    
...
Scenario Outline: Share Conversion of Preferred Holding 
  ...
  Examples:
  	|user	    |entity               |holding                                                      | quantity  |
  	|  	      |entity_type=Company  |orig_grant_quantity=100;investment_instrument=Preferred;preferred_conversion=2      | 10        |
    |  	      |entity_type=Company  |orig_grant_quantity=120;investment_instrument=Preferred;preferred_conversion=3      | 20        |    
