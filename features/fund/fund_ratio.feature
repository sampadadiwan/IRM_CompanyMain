...
Scenario Outline: Import Fund Ratio
  ...
  Given there is a CapitalCommitment with "folio_id=qwerty" 
  Given an Bulk Upload is performed for FundRatios
  ...
  Then I should find Fund Ratios created with correct data for Investor
