...
Scenario Outline: Create investor kyc - with custom fields as investor
  ...
  Examples:
    |custom_fields| files |
    |name=F1;field_type=File;required=true#name=F2;field_type=File;required=false#name=F3;field_type=TextField;required=true         | Upload PAN Card,Upload Address Proof,Upload Cancelled Cheque / Bank Statement,F1,F2|
    |name=F1;field_type=File;required=false#name=F2;field_type=File;required=false#name=F3;field_type=TextField;required=true         | Upload PAN Card,Upload Address Proof,Upload Cancelled Cheque / Bank Statement,F1|
