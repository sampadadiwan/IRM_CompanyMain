...
ActiveRecord::Schema[8.0].define(version: 2025_06_01_101005) do
  ...
  create_table "account_entries", force: :cascade do |t|
    ...
    t.index ["name", "fund_id", "capital_commitment_id", "entry_type", "reporting_date", "cumulative", "deleted_at", "parent_type", "parent_id"], name: "index_accounts_on_unique_fields", unique: true
