...
ActiveRecord::Schema[8.0].define(version: 2025_04_20_100001) do
  ...
  create_table "aggregate_portfolio_investments", force: :cascade do |t|
    ...
    t.bigint "orignal_id"
    t.decimal "base_fmv_cents", precision: 20, scale: 2, default: "0.0"
    t.decimal "base_cost_of_remaining_cents", precision: 20, scale: 2, default: "0.0"
    t.decimal "base_unrealized_gain_cents", precision: 20, scale: 2, default: "0.0"
