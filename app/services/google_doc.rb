...
class GoogleDoc
  ...
  def authorize
    ...
    if credentials.nil?
      ...
      Rails.logger.debug "Open the following URL in the browser and enter the " \
  ...
  def test_doc
    ...
    service.client_options.application_name = "IRM2"
    ...
    Rails.logger.debug { "The title of the document is: #{document.title}." }
  end
end
