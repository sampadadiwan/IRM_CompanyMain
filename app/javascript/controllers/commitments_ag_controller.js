...
export default class extends Controller {
  ...
  init() {
    ...
    let columnDefs = [
      {"field": "commitment_type", headerName: "Type", filter: "agSetColumnFilter"},
      {field: "folio_id", cellRenderer: this.html, headerName: "Folio"},
      {"field": "investor_name", cellRenderer: this.html, headerName: "Investor"},
      {"field": "full_name", cellRenderer: this.html, headerName: "Name"},
      {"field": "unit_type", headerName: "Unit Type", sortable: true, filter: "agSetColumnFilter"},
      {"field": "committed_amount", headerName: "Committed", sortable: true, filter: 'agNumberColumnFilter', filterValueGetter: (params) => { return this.extract_number(params.data.committed_amount) }},
      {"field": "percentage", headerName: "%", sortable: true, filter: 'agNumberColumnFilter', filterValueGetter: (params) => { return this.extract_number(params.data.percentage) }},
