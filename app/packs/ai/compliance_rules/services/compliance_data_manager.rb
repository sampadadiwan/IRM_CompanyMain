...
class ComplianceDataManager
  ...
  def self.test
    ...
    ComplianceAssistant.run_compliance_checks(PortfolioInvestment.find(8))
    ...
    ComplianceAssistant.run_compliance_checks(Fund.find(1))
    ...
    ComplianceAssistant.run_compliance_checks(CapitalCommitment.find(1))
  end
end
