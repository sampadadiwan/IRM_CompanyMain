...
class InfoOnInvestorsJob
  ...
  def t2_calculate_sum(kyc_sebi_datas, sub_cat, end_date, sum_method, fund_id, show_currency: true)
    sum = 0
  ...
  def get_table_2_row_data(scheme, kyc_sebi_datas, end_date, sr_no)
    sponsor_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Sponsor", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    manager_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Manager", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    personnel_of_sponsor_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Directors/Partners/Employees of Sponsor", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    personnel_of_manager_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Directors/Partners/Employees of Manager", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    employee_benefit_trust_of_manager_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Employee Benefit Trust of Manager", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    bank_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Banks", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    nbfc_coll_amt = t2_calculate_sum(kyc_sebi_datas, "NBFCs", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    insurance_companies_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Insurance Companies", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    pension_funds_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Pension Funds", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    provident_funds_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Provident Funds", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    aifs_coll_amt = t2_calculate_sum(kyc_sebi_datas, "AIFs", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    other_corporates_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Other Corporates", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    resident_individuals_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Resident Individuals", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    non_corporate_other_than_trusts_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Non-Corporate (other than Trusts)", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    trusts_coll_amt = t2_calculate_sum(kyc_sebi_datas, "Trusts", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    fpi_coll_amt = t2_calculate_sum(kyc_sebi_datas, "FPIs", end_date, :amount, scheme.id, show_currency: false).amount.to_d
    fvci_coll_amt = t2_calculate_sum(kyc_sebi_datas, "FVCIs", end_date, :amount, scheme.id, show_currency: false).amount.to_d
  ...
  def get_table_3_row_data(scheme, kyc_sebi_datas, end_date, sr_no)
    sponsor_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Sponsor", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    manager_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Manager", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    personnel_of_sponsor_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Directors/Partners/Employees of Sponsor", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    personnel_of_manager_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Directors/Partners/Employees of Manager", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    employee_benefit_trust_of_manager_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Employee Benefit Trust of Manager", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    bank_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Banks", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    nbfc_comm_amt = t3_calculate_sum(kyc_sebi_datas, "NBFCs", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    insurance_companies_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Insurance Companies", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    pension_funds_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Pension Funds", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    provident_funds_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Provident Funds", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    aifs_comm_amt = t3_calculate_sum(kyc_sebi_datas, "AIFs", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    other_corporates_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Other Corporates", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    resident_individuals_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Resident Individuals", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    non_corporate_other_than_trusts_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Non-Corporate (other than Trusts)", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    trusts_comm_amt = t3_calculate_sum(kyc_sebi_datas, "Trusts", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
    fpi_comm_amt = t3_calculate_sum(kyc_sebi_datas, "FPIs", end_date, :committed_amount, scheme.id, show_currency: false).amount.to_d
