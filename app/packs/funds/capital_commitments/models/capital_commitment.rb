class CapitalCommitment < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[created_at update_at folio_id commitment_date commitment_type fund_close investor_name onboarding_completed percentage unit_type committed_amount collected_amount call_amount distribution_amount esign_emails folio_currency].sort
  end
