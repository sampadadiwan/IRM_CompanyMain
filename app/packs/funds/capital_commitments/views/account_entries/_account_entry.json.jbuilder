json.extract! account_entry, :id, :capital_commitment_id, :entity_id, :fund_id, :entry_type, :name, :notes, :created_at, :updated_at, :reporting_date, :period, :cumulative, :parent_type, :parent_id, :parent_name, :commitment_name, :generated, :exchange_rate_id, :fund_formula_id, :rule_for, :import_upload_id, :allocation_run_id
