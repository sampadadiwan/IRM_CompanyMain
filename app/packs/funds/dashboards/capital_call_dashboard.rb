...
class CapitalCallDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  ATTRIBUTE_TYPES = {
    ...
    id: Field::Number,
    name: Field::String,
    percentage_called: Field::String.with_options(searchable: false),
  ...
  # Overwrite this method to customize how capital calls are displayed
  # across all pages of the admin dashboard.
  #
  def display_resource(capital_call)
    capital_call.name
  end
end
