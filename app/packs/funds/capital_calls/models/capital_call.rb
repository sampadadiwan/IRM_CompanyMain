class CapitalCall < ApplicationRecord
  ...
  FEE_TYPES = ["Investment Amount", "Fees Part Of Capital", "Other Fees"].freeze
  ...
  has_many :capital_commitments, through: :capital_remittances
  ...
  def notify_capital_call
    capital_remittances.pending.each do |cr|
      next if cr.capital_commitment.skip_call_notice?
