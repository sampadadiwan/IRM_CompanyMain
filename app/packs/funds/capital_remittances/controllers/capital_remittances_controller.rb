class CapitalRemittancesController < ApplicationController
  ...
  def capital_remittance_params
    params.require(:capital_remittance).permit(:entity_id, :fund_id, :capital_call_id, :investor_id, :status, :call_amount, :collected_amount, :notes, :verified, :payment_proof, :payment_date, properties: {})
  end
end
