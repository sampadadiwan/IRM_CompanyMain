class FundFormula < ApplicationRecord
  ...
  TYPES = %w[AllocateMasterFundAccountEntry AllocateAccountEntry-Name AllocateAccountEntry-EntryType AllocatePortfolio AllocatePortfolioInvestment GenerateAccountEntry CumulateAccountEntry GenerateCustomField Percentage GeneratePortfolioNumbersForFund CumulateForPortfolioCompany].sort.freeze
