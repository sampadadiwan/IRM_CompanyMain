class ImportCapitalDistribution < ImportUtil
  STANDARD_HEADERS = ["Fund", "Type", "Title", "Gross", "Date", "Generate Payments", "Payments Paid", "Reinvestment", "Folio No", "Distribution Basis"].freeze
  ...
  def save_capital_distribution(user_data, import_upload, custom_field_headers)
    ...
    if fund
      ...
      if CapitalDistribution.exists?(entity_id: import_upload.entity_id, fund:, title:)
        ...
        capital_distribution.cost_of_investment = user_data["Cost Of Investment"]
