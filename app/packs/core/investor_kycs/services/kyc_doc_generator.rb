class KycDocGenerator
  ...
  def amounts(investor_kyc, ccs, currency, start_date, end_date)
    ...
    OpenStruct.new({
                     ...
                     custom_uncalled_amount: Money.new(investor_kyc.custom_committed_amount.cents - call_amount_cents + investor_kyc.face_value_for_redemption(start_date: start_date, end_date: end_date).cents, currency)
                   })
  end
