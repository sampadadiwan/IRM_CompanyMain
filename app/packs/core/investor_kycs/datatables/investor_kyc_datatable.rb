class InvestorKycDatatable < ApplicationDatatable
  def view_columns
    @view_columns ||= {
      ...
      agreement_committed_amount: { source: "InvestorKyc.agreement_committed_amount_cents" },
    ...
    records.map do |record|
      {
        ...
        docs_completed: record.decorate.display_boolean(record.docs_completed),
        expired: record.decorate.expired,
        committed_amount: record.decorate.money_to_currency(record.committed_amount, params),
        agreement_committed_amount: record.decorate.money_to_currency(record.agreement_committed_amount, params),
