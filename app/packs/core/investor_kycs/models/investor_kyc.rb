class InvestorKyc < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[PAN full_name kyc_type address bank_name bank_branch bank_account_type bank_account_number ifsc_code birth_date verified expiry_date collected_amount committed_amount call_amount distribution_amount docs_completed json_fields created_at].sort
  end
