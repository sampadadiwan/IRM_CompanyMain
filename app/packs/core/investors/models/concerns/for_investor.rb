module ForInvestor
  ...
  included do
    ...
    def self.parent_class_type
      if %w[CapitalCommitment CapitalCall CapitalRemittance CapitalDistribution CapitalDistributionPayment FundUnit FundRatio FundUnit FundUnitSetting PortfolioInvestment AggregatePortfolioInvestment FundFormula FundReport PortfolioScenario].include?(name)
        Fund
