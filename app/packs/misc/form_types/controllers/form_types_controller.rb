class FormTypesController < ApplicationController
  ...
  def form_type_params
    params.require(:form_type).permit(:name, form_custom_fields_attributes: %i[id name position help_text field_type meta_data required read_only has_attachment show_user_ids step label _destroy])
  end
end
