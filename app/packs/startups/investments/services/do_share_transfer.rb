class DoShareTransfer
  ...
  before do |_organizer|
    context.audit_comment = "#{context.share_transfer.transfer_type} from #{context.share_transfer.from_investor.investor_name} to #{context.share_transfer.to_investor&.investor_name}"
  end
