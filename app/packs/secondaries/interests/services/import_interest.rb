class ImportInterest < ImportUtil
  STANDARD_HEADERS = ["Buyer Entity Name", "Address", "Contact Name", "City", "Pan", "Demat", "Bank Account", "Ifsc Code", "Buyer Signatory Emails", "Investor", "Quantity", "Price", "Shortlisted", "Escrow Deposited", "Update Only"].freeze
